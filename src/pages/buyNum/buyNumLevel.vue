<template>
  ...
  <div class="mb20 fz14">
    ...
    <div class="mb20">
      ...
      <el-button type="primary" size="medium" :disabled="disabled" @click="editLevel"><i
    ...
    <!-- 重新分配-->
    <el-dialog title="买号等级分配信息" :visible.sync="accountModel" width="90%" :close-on-click-modal="false"
            ...
            <el-row class="pt20">
              <el-col :xs="24" :span="5" :sm="9" :md="8" :lg="5">
                <el-form-item label="搜索内容">
                  <el-input v-model="accountSearchForm.searchKeyWords" placeholder="请输入类型搜索"
                            class="disInline"></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :span="5" :sm="10" :md="8" :lg="5" class="ml20">
                <el-button type="primary" size="medium">查询</el-button>
      ...
      <div class="mb20">
        <el-button size="medium" type="primary" @click="editParamValue" :disabled="disabled1"><i
          class="el-icon-edit-outline"></i>修改参数值
        </el-button>
  ...
  data () {
    return {
      ...
      editRules: {
        ...
        allBuyMoney: [
          { required: true, message: '请输入累积购买金额', trigger: 'blur' }
        ],
        allBuyCount: [
          { required: true, message: '请输入累积购买次数', trigger: 'blur' }
        ],
        allCommentNum: [
          { required: true, message: '请输入累积留评次数', trigger: 'blur' }
        ],
        priceStart: [
          { required: true, message: '请输入价格开始区间', trigger: 'blur' }
        ],
        priceEnd: [
          { required: true, message: '请输入价格结束区间', trigger: 'blur' }
        ],
        sort: [
