<template>
	<div class="container">
		...
		<div class="mb20">
			...
			<el-button type="primary" size="medium" @click="delHandel" :disabled="disabled"><i class="el-icon-takeaway-box"></i>重置虚拟卡
			</el-button>
			<el-button type="primary" size="medium" @click="delHandel" :disabled="disabled"><i class="el-icon-edit-outline"></i>修改额度
			</el-button>
			...
			<el-form :model="cardForm" ref="cardForm" :rules="editRules" class="demo-dynamic" label-width="88px" status-icon>
				...
				<el-tabs type="border-card" class="mb20">
					<el-tab-pane label="虚拟信用卡管理">
						<div class="mb10"><el-button size="small" @click="addCard">新增</el-button></div>
						<div class="cardBox">
							<ul class="listTitle">
								<li>虚拟卡号</li>
								<li>有效期</li>
								<li>安全码</li>
								<li>虚拟卡额度($)</li>
								<li class="lastLi"><el-button type="danger" size="small" style="visibility: hidden;">删除</el-button></li>
							</ul>
							<div v-for="(index,item) in cardListData">
								...
								<li><el-input class="inpWid" v-model="item.validity"></el-input></li>
								<li><el-input class="inpWid" v-model="item.safetyCode"></el-input></li>
								<li><el-input class="inpWid" v-model="item.amount"></el-input></li>
								<li class="lastLi"><el-button type="danger" size="small" @click=removeCardList(item,index)>删除</el-button></li>
							</ul>
							</div>
						</div>
					</el-tab-pane>
	...
	export default {
		...
		data() {
			return {
				...
				cardListData:[
				{cardNo:'',validity:'',safetyCode:'',amount:''}
				],
				editRules: {
					validity: [{
						required: true,
		...
		methods: {
			...
			addCard(){
				let _this = this
				_this.cardListData.push({cardNo:'',validity:'',safetyCode:'',amount:''})
			},
			//新增虚拟卡删除
