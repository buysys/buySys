<template>
	<div class="container">
		...
		<!--编辑资料-->
		<el-dialog title="个人信息编辑" :visible.sync="userDataModel" :close-on-click-modal="false" :before-close="closeUserDataModel" center width="30%">
		...
		<!--修改密码-->
		<el-dialog title="修改密码" :visible.sync="changePwdModel" :close-on-click-modal="false" :before-close="closePwdModel" center width="30%">
