<template>
  <div class="container">
      ...
      <div class="searchBox mb20">
        <el-form ref="searchForm" :model="searchForm" class="form-item" :inline='true' label-width="60px">
          <el-form-item label="时间">
            <el-date-picker v-model="searchForm.start" type="date" placeholder="选择开始时间" value-format="yyyy-MM-dd" size="small"></el-date-picker>
            <span>-</span>
    ...
    <div class="mb20">
      <el-button type="success" size="small" @click="outMoney" :disabled="disabled"><i class="el-icon-circle-check"></i>
        确认提现</el-button>
      <el-button type="danger" size="small" @click="errPay" :disabled="disabled"><i class="el-icon-circle-close"></i>
        提现失败</el-button>
