<template>
	<div class="container">
		...
		<div class="mb20">
			<el-button type="primary" size="medium" @click="okModelShow" :disabled="disabled"><i class="el-icon-circle-check"></i>确认退款</el-button>
			...
			<el-form :model="viewForm" label-width="125px" status-icon>
				<el-row>
					<el-col :span="12" :xs="24">
						<el-form-item label="客户编号:"><label>{{viewForm.userNo}}</label></el-form-item>
					</el-col>
					<el-col :span="12" :xs="24">
				...
				<el-row>
					<el-col :span="12" :xs="24">
						<el-form-item label="收款类型:"><label>{{viewForm.receiptsType}}</label></el-form-item>
					</el-col>
					<el-col :span="12" :xs="24">
						<el-form-item label="收款账号:"><label>{{viewForm.receiptsNo}}</label></el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12" :xs="24">
						<el-form-item label="流水号:"><label>{{viewForm.pipelineNo}}</label></el-form-item>
					</el-col>
					<el-col :span="12" :xs="24">
						<el-form-item label="付款时间:"><label>{{viewForm.payTime}}</label></el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12" :xs="24">
						<el-form-item label="退款金额:"><label>{{viewForm.refundAmount}}</label></el-form-item>
					</el-col>
					<el-col :span="12" :xs="24">
						<el-form-item label="退款状态:"><label>{{viewForm.status}}</label></el-form-item>
					</el-col>
				</el-row>
				<el-row>
