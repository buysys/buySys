  ...
  <div>
          ...
          <el-row>
              ...
              <el-form-item label="平台">
                <template>
                  <el-select v-model="sPlatformValue" placeholder="请选择">
                    <el-option v-for="item in sPlatformOptions" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                  </el-select>
                </template>
              </el-form-item>
            ...
            <el-col :xs="24" :span="4">
              <el-form-item label="搜索内容">
                <el-input v-model="searchForm.searchkeywords" placeholder="请输入编码/类型搜索"></el-input>
              </el-form-item>
            </el-col>
    ...
    <div class="mt10">
      ...
      <div class="table-foot">
        <div>
          <p class="mt10 fz14" style="color: red;">平台服务费 = 订单数量 * 每单服务费</p>
        </div>
        <div>
          ...
          <el-form-item label="归属类型" prop="ascriptionType">
            <template>
              <el-select v-model="editForm.ascriptionType" placeholder="请选择归属类型" style="width: 100%;" @change="changeForm">
                <el-option v-for="item in aTypeOptions" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </template>
          </el-form-item>
          ...
          <el-form-item label="留评比例" prop="commentBL">
            <template>
              <el-select v-model="editForm.commentBL" placeholder="请选择留评比例" style="width: 100%;">
                <el-option v-for="item in commentBLOptions" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </template>
          </el-form-item>
