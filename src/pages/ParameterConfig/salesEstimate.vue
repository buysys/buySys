					...
					<el-row>
						<el-col :xs="24" :span="6">
							<el-form-item label="产品排名">
								<el-input v-model="searchForm.searchkeywords" placeholder="请输入产品排名进行查询" class="disInline"></el-input>
							</el-form-item>
						</el-col>
      ...
      <el-button type="danger" size="medium" @click="delData" :disabled="delDisabled"><i class="el-icon-delete"></i>删除</el-button>
		...
		<div class="mt10">
			<el-table :data="tableData" id="exportData" style="width: 100%" :header-cell-style="{background:'#fafafa'}" @selection-change="handleSelectionChange">
				...
				<el-table-column prop="ProductByASIN" label="产品类型" align="center"></el-table-column>
		...
		<el-dialog :title="title" :visible.sync="editModel" :close-on-click-modal="false">
			<el-form :model="editForm" :rules="editRules" label-width="80px" status-icon>
				...
				<el-form-item label="产品类型">
					<el-select v-model="editForm.type" placeholder="请选择产品类型" style="width: 100%;">
