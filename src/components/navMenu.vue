<template>
	<div class="navCon">
		<div class="navHead">
			<div class="line"></div>
			<el-menu :default-active="onRoutes" background-color="#001529" text-color="#fff" active-text-color="#5FB878" class="el-menu-demo navBox"
			mode="horizontal" @select="handleSelect" unique-opened router>
				<el-menu-item>
				...
				<el-menu-item index="TaskList"><i class="el-icon-document"></i>任务管理</el-menu-item>
				...
				<el-menu-item index="customerList"><i class="el-icon-news"></i>客户管理</el-menu-item>
				<el-menu-item index="userManage"><i class="el-icon-user"></i>用户管理</el-menu-item>
        <el-menu-item index="financeManage"><i class="el-icon-data-line"></i>财务管理</el-menu-item>
